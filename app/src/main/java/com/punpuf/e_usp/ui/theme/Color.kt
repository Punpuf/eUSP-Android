...
// USP Colors
val UspGalaxy900 = Color(0xff025d67)
val UspGalaxy800 = Color(0xff0b8092)
val UspGalaxy700 = Color(0xff1094ab)
val UspGalaxy600 = Color(0xff17a8c5)
val UspGalaxy500 = Color(0xff1bb8d9)
val UspGalaxy400 = Color(0xff2ec3e0)
val UspGalaxy300 = Color(0xff50cde7)
val UspGalaxy200 = Color(0xff81dcef)
val UspGalaxy100 = Color(0xffb3e9f6)
val UspGalaxy50 = Color(0xffe0f6fc)

val UspLake900 = Color(0xff3c5d5e)
val UspLake800 = Color(0xff4c8086)
val UspLake700 = Color(0xff53949e)
val UspLake600 = Color(0xff5aa9b7)
val UspLake500 = Color(0xff61b9ca)
val UspLake400 = Color(0xff64c3d2)
val UspLake300 = Color(0xff72cedb)
val UspLake200 = Color(0xff92dce6)
val UspLake100 = Color(0xffbaeaf0)
val UspLake50 = Color(0xffe3f7f9)

val UspAmber900 = Color(0xfff97219)
val UspAmber800 = Color(0xfffa901c)
val UspAmber700 = Color(0xfffba11e)
val UspAmber600 = Color(0xfffcb321)
val UspAmber500 = Color(0xfffdc126)
val UspAmber400 = Color(0xfffdca37)
val UspAmber300 = Color(0xfffed457)
val UspAmber200 = Color(0xfffee087)
val UspAmber100 = Color(0xfffeecb5)
val UspAmber50 = Color(0xfffff8e2)
