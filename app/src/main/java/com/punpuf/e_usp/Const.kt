...
class Const {
    companion object {
        ...
        // Table for Book of User
        const val TABLE_BOOK_OF_USER = "table_book_user"
        const val TABLE_BOOK_OF_USER_SYS_NO = "table_book_user_sys_no"
        const val TABLE_BOOK_OF_USER_TYPE = "table_book_user_type"
        const val TABLE_BOOK_OF_USER_ITEM_SEQ = "table_book_user_item_seq"
        const val TABLE_BOOK_OF_USER_HOLD_SEQ = "table_book_user_hold_seq"
        const val TABLE_BOOK_OF_USER_CALL_NO = "table_book_user_call_no"
        const val TABLE_BOOK_OF_USER_TITLE = "table_book_user_title"
        const val TABLE_BOOK_OF_USER_AUTHORS = "table_book_user_authors"
        const val TABLE_BOOK_OF_USER_LIBRARY_CODE = "table_book_user_library_code"
        const val TABLE_BOOK_OF_USER_LIBRARY_NAME = "table_book_user_library_name"
        const val TABLE_BOOK_OF_USER_MEDIA_TYPE = "table_book_user_media_type"
        const val TABLE_BOOK_OF_USER_DUE_DATE = "table_book_user_due_date"
        const val TABLE_BOOK_OF_USER_RETURN_DATE = "table_book_user_return_date"
        const val TABLE_BOOK_OF_USER_NO_RENEW = "table_book_user_no_renew"

        // Table for Book of Search
        const val TABLE_BOOK_OF_SEARCH = "table_book_of_search"
        const val TABLE_BOOK_OF_SEARCH_SYS_NO = "table_book_of_search_sys_no"
        const val TABLE_BOOK_OF_SEARCH_BASE = "table_book_of_search_base"
        const val TABLE_BOOK_OF_SEARCH_TITLE = "table_book_of_search_title"
        const val TABLE_BOOK_OF_SEARCH_AUTHORS = "table_book_of_search_authors"
        const val TABLE_BOOK_OF_SEARCH_EDITOR = "table_book_of_search_editor"
        const val TABLE_BOOK_OF_SEARCH_IDIOM = "table_book_of_search_idiom"
        const val TABLE_BOOK_OF_SEARCH_MEDIA_TYPE = "table_book_of_search_media_type"
        const val TABLE_BOOK_OF_SEARCH_PUBLICATION_DATE = "table_book_of_search_pub_date"
        const val TABLE_BOOK_OF_SEARCH_SUBJECTS = "table_book_of_search_subjects"
        const val TABLE_BOOK_OF_SEARCH_LOCATIONS = "table_book_of_search_locations"
        ...
        const val SHARED_PREFS_APP_LAST_FETCH_LIBRARY_LOANS = "app_last_fetch_library_loans"
        const val SHARED_PREFS_APP_LAST_FETCH_LIBRARY_RESERVATION = "app_last_fetch_library_reservation"
        const val SHARED_PREFS_APP_LAST_FETCH_LIBRARY_HISTORY = "app_last_fetch_library_history"
